 ...
 */
@RestController
@RequestMapping("/home/reco/product")
@Api(tags = "首页人气推荐管理API")
public class HomeRecommendProductController {
    @Autowired
    private HomeRecommendProductService service;
    ...
    public BaseResponse add(@RequestBody List<SmsHomeRecommendProduct> params) {
